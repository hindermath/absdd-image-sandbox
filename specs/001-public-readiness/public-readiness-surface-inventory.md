...
| `AGENTS.md` | agent-guidance | Codex-like agents | bilingual | updated | genericize | Hosting-platform guidance points to GitHub repository-side governance and Owner/Admin platform rules |
...
| PA-005 | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/copilot-instructions.md` | Previous private hosting phrasing could be read as required hosting platform | platform | public-confusion | genericize | Agent guidance now describes GitHub repository-side governance and leaves platform rules as Owner/Admin action | Maintainer | Hosting platform change |
