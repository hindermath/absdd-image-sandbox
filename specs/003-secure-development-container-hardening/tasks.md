...
- [X] T051 [P] Erfasse auf einem echten Linux-Host Bash-/PowerShell-Paritaet, rootless Podman und verfuegbare VS-Code-Ergebnisse in `docs/security/secure-development/2026-08-30-container-hardening/platform-linux.md`; ist kein Linux-Runner verfuegbar, schreibe `Open`, Owner und Trigger „erneut bei verfuegbarem Linux-rootless-Podman-Runner“, niemals macOS-Ersatz oder `N/A` (FR-004a, FR-013, FR-019–FR-020, CP-001–CP-005, GATE-XPLAT-LINUX-01; depends on T049).
- [X] T052 [P] Erfasse auf Windows/WSL2 PowerShell-`-WhatIf`, Bash-/PowerShell-Paritaet, Podman und verfuegbare VS-Code-Ergebnisse in `docs/security/secure-development/2026-08-30-container-hardening/platform-windows-wsl2.md`; ist kein Runner verfuegbar, schreibe `Open`, Owner und Trigger „erneut bei verfuegbarem Windows/WSL2-PowerShell7-Podman-Runner“, niemals macOS-Ersatz oder `N/A` (FR-004a, FR-013, FR-019–FR-020, CP-001–CP-005, GATE-XPLAT-WIN-01; depends on T049).
...
- [X] T061 [US5] Lasse ausschliesslich `Learning/A11Y Review` den moderierten, datierten Erstnutzungstest fuer alle vier Berufe ohne Spec-Kit-Vorerfahrung, 30-Minuten-Grenze und mindestens 90 Prozent Erfolg ausfuehren und aggregierte nicht sensible Ergebnisse in `docs/security/secure-development/2026-08-30-container-hardening/learner-first-use-results.json` schreiben; fehlt die echte Beobachtung, bleibt `GATE-LEARNER-01` offen und der Agent erzeugt keine Ersatzdaten (FR-018–FR-020, GR-001–GR-004, SC-009, GATE-LEARNER-01; depends on T060; Human-owned, not model-completable).
...
- [X] T064 [US5] Konsolidiere macOS-, Linux- und Windows/WSL2-Ergebnisse ohne Ersatzannahmen in `docs/security/secure-development/2026-08-30-container-hardening/platform-parity.md`; ein fehlendes Applicable-Plattformgate bleibt `Open` und blockiert positiven `MergeAndSync`-Abschluss bis zum genannten Runner-Trigger (FR-004a, FR-013, FR-019–FR-020, CP-001–CP-005, GATE-XPLAT-01; depends on T050–T052, T063).
