...
| 2.5.0 | 2026-05-22 | Security-Verantwortliche*r | Refined section "Agentic AI in Sandbox Environments": feature implementations with agentic AI use GitHub Spec Kit with the SDD flow and the seven governance presets unless a justified exception is documented; synchronized with CL_09 and CL_12 |
