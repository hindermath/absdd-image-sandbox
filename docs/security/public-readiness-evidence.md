...
| Branch protection / hosting enforcement | context-evidence | `docs/security/branch-protection.md`, `.gitlab/CODEOWNERS`, `.gitlab/merge_request_templates/Default.md` | GitLab CE evidence records a hosting context; public guidance now treats platform enforcement generically | Owner / platform admin | Reassess for the active public hosting platform | Hosting platform or visibility change |
