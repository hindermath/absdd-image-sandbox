...
| Optionaler home-baseline-Workflow / Optional home-baseline workflow | active-evidence | `README.md`, `compose.home-baseline.yml` | Als optionaler Checkout des persoenlichen Forks beschrieben, nicht als Image-Inhalt. | Maintainer | Fork- und Mount-Anleitung synchron halten. | Fork- oder Mount-Workflow-Aenderung |
...
| Optional `home-baseline` workflow | active-evidence | `README.md`, `compose.home-baseline.yml` | Described as an optional checkout of the learner's personal fork, not as image content | Maintainer | Keep fork and mount guidance aligned | Fork or mount workflow change |
